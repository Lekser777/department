...
public interface DepartmentMapper {
    ...
    @Select("select distinct a.\"Name\",a.\"Creation_date\",a.\"First_name\",a.\"Last_name\",b.count from(select \"Department\".\"Name\",\"Department\".\"Creation_date\",\"First_name\",\"Last_name\" from \"Department\",\"Employee\",\"Department_of_employee\" where (\"Department\".\"Id\"=\"Dep_id\" and \"Employee\".\"Id\" =\"Empl_id\" and \"Is_boss\"=true and \"Department\".\"Id\"=#{id})) as a,(select \"Dep_id\",count(\"Empl_id\") from \"Department_of_employee\" group by(\"Dep_id\")) as b")
    ...
    @Insert("INSERT INTO \"Department\"(\"Id\",\"Name\",\"Creation_date\") VALUES (DEFAULT,#{name} ,#{creation_date})")
